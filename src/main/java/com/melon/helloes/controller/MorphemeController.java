...
public class MorphemeController {
	...
	public String analyzeLyrics(@RequestParam("artistId") String artistId) throws UnsupportedEncodingException {
		TreeSet<TermCount> termCounts = analysisService
				.morphemeIntroAnalyzeLyrics(URLDecoder.decode(artistId, "UTF-8"));
	...
	public String prefixArtistAggs(@RequestParam("term") String term, @RequestParam("size") int size)
